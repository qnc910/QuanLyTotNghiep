              ...
              <form action="#" method="POST">
                ...
                <div class="form-group">
                  <div class="form-label-group">
                    <input type="text" name="txt_masv" id="inputMasv" class="form-control" placeholder="Mã sinh viên" value="<?php echo $value['masv'];?>" required="required" autofocus="autofocus">
                ...
                <div class="form-group">
                  <div class="form-label-group">
                    <input type="text" name="txt_hoten" id="inputTensv" class="form-control" placeholder="Họ và tên" value="<?php echo $value['hoten'];?>" required="required">
                ...
                <div class="form-group">
                  <div class="form-label-group">
                    <input type="date" name="txt_ngaysinh" id="inputNgaysinh" class="form-control" placeholder="Ngày sinh" value="<?php echo $value['ngaysinh'];?>" required="required">
                ...
                <div class="form-group">
                  <div class="form-label-group">
                    <input type="text" name="txt_malop" id="inputLop" class="form-control" placeholder="Lớp" value="<?php echo $value['lop'];?>" required="required">
                ...
                <div class="form-group">
                  <div class="form-label-group">
                    <input type="text" name="txt_khoa" id="inputKhoa" class="form-control" placeholder="Khoa" value="<?php echo $value['khoa'];?>" required="required">
