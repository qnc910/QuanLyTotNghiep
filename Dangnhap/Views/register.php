    ...
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
        <form action="#" method="POST">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="inputAddress" name="txtAddress" class="form-control" placeholder="Địa chỉ" required="required">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="inputPhone" name="txtPhone" class="form-control" placeholder="Số điện thoại" required="required">
